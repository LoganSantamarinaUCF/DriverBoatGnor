...
float speed_scalar;
bool boosted = false; //tells the program if the boat has boosted yet
...
//function that calculates the angle between two points while following the parametric equation from CurveX and CurveY functions
float UpdateAngle(){
  //point p
  ...
  float value = vertical / horizontal;
  return atan(value);
}
